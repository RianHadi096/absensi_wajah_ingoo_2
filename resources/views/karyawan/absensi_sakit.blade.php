...
<body>
    ...
    <main>
        <div class="container">
            <h2 class="mt-4 mb-4 text-center">Upload Bukti Sakit</h2>
            
            <div class="upload-container">
                <h5 class="mb-4 text-center">Upload Foto/Dokumen Sakit</h5>
                ...
                <!-- Hidden File Input -->
                <input type="file" id="fileInput" class="file-input-hidden" accept="image/*,.pdf" multiple>
                ...
                <form method="POST" action="{{ route('upload-sakit') }}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="successMessage" class="mb-0">Absensi sakit Anda telah berhasil terekam.</p>
                </div>
        ...
        uploadBtn.addEventListener('click', () => {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('successMessage').textContent = data.message || 'Absensi sakit Anda telah berhasil terekam.';
                    successModal.show();
